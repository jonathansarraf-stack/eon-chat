...
Environment ID: ${session.environment_id || session.session_environment_id || 'not-selected'}
Project ID: ${session.project_id || session.session_project_id || 'not-selected'}
